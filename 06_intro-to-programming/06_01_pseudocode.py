...
#save each kitten name, confirmation of being cute, add a message "ready for adoption"

print("Tom: cute: ready for adoption")
print("Tim: cute: ready for adoption")
print("Tam: cute: ready for adoption")
print("Tem: cute: ready for adoption")
