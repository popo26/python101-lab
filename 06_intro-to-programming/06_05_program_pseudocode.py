...
## Cleaning up temp folders automatically
# go to %temp% and delete everything in there.
# if some files that require admin access, skip them.


## When a drive usage goes above 80%, it will alerts me
